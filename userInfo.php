...
<head>
  ...
  <title>UserInfo | All Grills Restaurant</title>
  ...
  <section class="contact">
    ...
    <div class="container">
      <div class="offset-lg-3 col-lg-6 text-center text-center pt-0">
        <h1 class="title_g">User Details</h1>
      ...
      <div class="row">
        <div class="col">
          <div class="r_table table-responsive">
            <h2>Admin</h2>
                ...
                while ($row = mysqli_fetch_assoc($result)){
                  ...
                  if ($customerType=='customer') { 
                    ...
                    <tr>
                      ...
                      <td><?php echo $phoneNo; ?></td>
                      <td><?php echo $customerAddress; ?></td>
                      <td><a href="userInfo.php?delete=<?php echo $customerId;?>" onclick="removed()" class="btn btn-danger"  data-toggle="tooltip" data-html="true"  title="Delete" data-placement="bottom" ><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                    </tr>
                  <?php  } 
                }?>
              </tbody>
