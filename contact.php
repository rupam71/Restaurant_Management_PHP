...
if(isset($_POST['contact'])){
  ...
  $ti=(date("d-m-y, H:i:s",time()+3600*6));

  $sql ="INSERT INTO contact (name, email, headline, description, time) 
        VALUES ('$name', '$email','$headline','$description', '$ti')";
          ...
          <div class="row mt-5">
            <div class="offset-3 col-md-6">
              ...
              <div class="reservation_title text-center justify-content-center pt-0">
                <h1 class="title_g">Contact With Us</h1>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group ">
                  <label class="loginTextColor">Name</label>
                ...
                <div class="form-group ">
                  <label class="loginTextColor">HeadLine</label>
                  <input type="text" name="headline" class="form-control" autocomplete="off" placeholder="Headline * "required>
                </div>
                <div class="form-group">
                    <label class="loginTextColor ">Description</label>
                    <textarea class="form-control" name="description" rows="6" autocomplete="off" placeholder="Write your Message here * "required></textarea>
                </div>
                <div class="col-lg text-center">
                  <button type="submit" class="btn btn-submit" name="contact" onclick="Message();">Send Message</button>
                </div>
              </form>
            </div>
          </div>
